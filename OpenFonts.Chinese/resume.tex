...
\namesection{张}{君 涵}{
    \makebox[\textwidth][c]{%
        \urlstyle{same}\href{mailto:2907402968@qq.com}{email：2907402968@qq.com} | phone：1520 6110 955
        
    }
    \makebox[\textwidth][r]{%
        \raisebox{0pt}[0pt][0pt]{\includegraphics[width=2.5cm]{bbb.jpeg}}
        \hspace{0.02cm} % 可调距离，图片与右边界的距离
    }
    {年龄：23} | {籍贯：江苏} | {意向岗位: 嵌入式开发工程师/c,c++工程师}
}

% \namesection{张}{君 涵}{
%     \makebox[\textwidth][c]{%
%         \urlstyle{same}\href{mailto:2907402968@qq.com}{2907402968@qq.com} | 1520 6110 955
%         % \hfill
%         \hspace{4.5cm} 
%         \raisebox{0pt}[0pt][0pt]{\includegraphics[width=2cm]{bbb.jpeg}}
%     }
% }
% \namesection{张}{君 涵}{%
%   \urlstyle{same}\href{mailto:2907402968@qq.com}{2907402968@qq.com} | 1520 6110 955%
%   \hfill
%   \adjustbox{valign=t}{\includegraphics[width=2cm,height=3.5em,keepaspectratio]{aaa.jpg}}%
% }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     COLUMN ONE
...
\descript{participant,\href{https://github.com/purplefrigid/Zynq-Simple-Oscilloscope.git}{\bf 基于zynq7020的多功能示波器}}
...
\location{2025.03}
\begin{tightemize}
    \item 部署yolov5和ollama到算能SG2002开发板上
...
\runsubsection{\bf 基于RV1106和imx6ull的智能监控系统设计}
\descript{leader}
\location{2024.10}
\begin{tightemize}
    \item 在幸狐rv1106开发板上移植uboot，Linux内核，buildroot根文件系统
    \item 添加设备树，编写摄像头驱动
    \item 移植ffmpeg，搭建流服务器，实现rtmp推流
    \item 在imx6ull移植yolov5和QT
    \item 编写ui界面，显示经yolov5预测的监控视频
    \end{tightemize}
\sectionsep
...
\section{研究方向与论文}
\sectionsep
\runsubsection{\bf 基于机器学习的边缘电磁结构设计与性能优化研究}
\descript{leader}
\location{论文}
\begin{tightemize}
    \item Design of honeycomb structure wing leading edge based on NN and RPSO（AWPL，中科院二区，第一作者），under rewiew
    \item Bayesian active learning sampling optimisation for predicting RCS characteristics of gradient honeycomb structures(CMC，第一作者)，under rewiew
    \end{tightemize}
\sectionsep
